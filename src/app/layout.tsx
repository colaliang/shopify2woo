...
export const metadata: Metadata = {
  ...
  title: {
    default: "WordPress产品导入助手 - Shopify/Wix/WordPress产品一键导入WooCommerce",
    template: "%s | 产品导入助手"
  },
  ...
  keywords: ["WordPress导入WooCommerce", "Shopify导入WooCommerce", "Wix导入WooCommerce", "跨境电商工具", "产品搬家", "WooCommerce插件", "店铺同步", "产品采集"],
  ...
  openGraph: {
    ...
    title: "WordPress产品导入助手 - Shopify/Wix/WordPress产品一键导入WooCommerce",
    description: "专业的外贸和跨境电商产品导入工具，支持从WordPress, Shopify, Wix一键导入产品到WooCommerce/WordPress。抓取网站产品公开信息，不需要原网站的API，支持批量采集、自动化同步、图片迁移，无缝对接，提升运营效率。",
    siteName: "产品导入助手",
  },
  twitter: {
