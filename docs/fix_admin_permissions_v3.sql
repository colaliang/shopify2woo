-- Fix Admin Permissions and Search (Inline Variable)
-- Some Postgres versions/clients struggle with DECLARE in DO blocks or simple functions if not formatted perfectly.
-- We will avoid the variable declaration and use the expression directly in the IF statement.
